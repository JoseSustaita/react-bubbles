...
To keep data secured make sure that you are not passing around sensative data if you do not need to. Ex. Login info

- [ ] Describe how web servers work.

Web servers work by using HTTP protocol.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

GET request can be used to map to the CRUD.
